...
//How might the id be useful when saving the description in local storage?
    //when I click the button, figure out what hour its for, then once we have the hour, store the event name that I defined for the hour. The id is for each hour
...
//only need the hour for the daily planner
  ...
  //trying to use this source for the local storage even though its session storage https://developer.mozilla.org/en-US/docs/Web/API/Window/sessionStorage 